  ...
  return (
    <div className="container mx-auto py-8 space-y-6">
      ...
      <p className="text-center text-muted-foreground max-w-2xl mx-auto">
        Generate videos and animations with AI-powered tools. Transform your ideas into engaging 
        video content without needing professional video editing skills.
      </p>
