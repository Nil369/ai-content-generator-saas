...
import { projects } from "@/constants/featured_projects";
      ...
      <main className="flex-grow container mx-auto px-4 py-12">
        ...
        <section className="mb-20">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <h2 className="text-2xl md:text-3xl text-purple-500 font-semibold mb-6">
                Full Stack Developer
              </h2>
              <p className="text-lg text-muted-foreground mb-8">
                A passionate and experienced Full Stack Developer with expertise
                in creating modern web applications. Skilled in React, Next.js,
                Node.js, and various web technologies to build solutions that
        ...
        <section className="mb-20">
          ...
          <div className="text-lg space-y-6 text-muted-foreground">
            <p>
              I am a full-stack developer with a passion for creating powerful,
              responsive, and user-friendly web applications. With several years
              of experience in web development, I've worked on a variety of
              projects from small business websites to complex enterprise
              applications.
            </p>
            <p>
              My journey in tech started with a deep curiosity about how
              websites work. This led me to pursue Computer Science and dive
              deep into programming languages and frameworks.
            </p>
            <p>
        ...
        <section className="mb-20">
          ...
          <div className="mb-16">
            <h3 className="text-xl font-semibold mb-8 text-purple-500">
              Core Skills
            </h3>
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-2 xl:grid-cols-4 gap-6">
              {skills.map((skill, i) => (
                <div
                  key={i}
                  className="bg-gradient-to-br from-muted/30 to-muted/10 dark:from-black/40 dark:to-black/20 border border-black/5 dark:border-white/10 rounded-lg py-4 px-2 h-full flex flex-col items-center text-center transition-transform transform hover:scale-105"
                >
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-6 gap-6">
              {[
                ...
                <div key={i} className="group">
                  <div className="p-5 h-full flex flex-col justify-between bg-muted/10 dark:bg-black/20 rounded-lg hover:bg-purple-500/5 dark:hover:bg-purple-500/10 transition-all duration-300">
